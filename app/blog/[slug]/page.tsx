    ...
    <article className="bg-white">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-10">
        ...
        {(post.thumbnail || post.image) && (
          ...
          <img src={post.thumbnail || (post.image as string)} alt={post.title} className="mt-6 aspect-[16/9] w-full rounded-2xl object-cover border" />
        )}
        ...
        <div className="mt-12 border-t pt-6">
          <Link href="/blog" className="inline-flex items-center gap-2 text-emerald-700 hover:underline">← Back to all posts</Link>
        </div>
      </div>
    </article>
  );
